...
/// the user or an error occurs. The operation is performed asynchronously. Capture events will be delivered via the callback. When enabled, raw microphone data can be captured.
